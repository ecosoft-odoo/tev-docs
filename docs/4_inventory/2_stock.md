...
1. ที่เมนู Receipts แสดงจำนวนรายการที่รอรับของเข้าสต็อก
![](img/stock_1.png) 
...
3. ระบบแสดงรายการรอรับของเข้าสต็อก สถานะ Ready เป็นค่าเริ่มต้น 
![](img/stock_3-3.png)
    * ค้นหารายการรับของด้วยการกรอกเลขที่ใบ PO 
    * เลือกการค้นหาด้วย Source Document
...
3. ระบบแสดงรายการรอส่งของ สถานะ Ready เป็นค่าเริ่มต้น 
![](img/stock_10.png)
    * ค้นหารายการรับของด้วยการกรอกเลขที่ใบ SO 
    * เลือกการค้นหาด้วย Source Document
กดเลือกเอกสารเพื่อทำรายการส่งของ
![](img/stock_10-1.png)
