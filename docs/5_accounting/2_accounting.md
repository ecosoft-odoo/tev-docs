    ...
    * กรณีตัดจำหน่ายจากการขาย
    ![](img/ass_21-1.png)
        ...
        * (8) Note: บันทึกข้อความเพิ่มเติม (ถ้ามี)
        !!! Warning
            กรณีขายสินทรัพย์ ก่อนหรือหลังการตัดจำหน่ายสินทรัพย์จากการขาย จะต้องทำขั้นตอนตั้งลูกหนี้ (Customer Invoice) และบันทึกรับชำระเงิน (Customer Payment) ด้วยทุกครั้ง
